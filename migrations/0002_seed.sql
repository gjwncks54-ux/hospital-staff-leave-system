...
INSERT INTO leave_requests (id, emp_id, type, start_date, end_date, amount, status, reason, approved_leader_id, approved_hr_id, created_at, updated_at) VALUES
  (1, 5, 'ANNUAL', '2026-04-15', '2026-04-15', 1.0, 'APPROVED_LEADER', '가족 행사 참석', 4, NULL, '2026-04-07 09:00:00', '2026-04-07 09:30:00'),
  (2, 5, 'HALF_PM', '2026-04-11', '2026-04-11', 0.5, 'PENDING', '치과 진료', NULL, NULL, '2026-04-08 08:40:00', '2026-04-08 08:40:00'),
  (3, 6, 'SICK', '2026-04-09', '2026-04-10', 0.0, 'PENDING', '진료 및 회복', NULL, NULL, '2026-04-08 10:00:00', '2026-04-08 10:00:00'),
  (4, 6, 'ANNUAL', '2026-03-20', '2026-03-20', 1.0, 'APPROVED_HR', '개인 일정', 4, 3, '2026-03-10 13:00:00', '2026-03-10 15:20:00');
...
INSERT INTO leave_request_events (leave_request_id, actor_id, action, note, created_at) VALUES
  ...
  (4, 3, 'REQUEST_APPROVED', '인사팀 최종 승인', '2026-03-10 15:20:00');
